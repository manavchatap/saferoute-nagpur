...
const BLACKSPOTS_DATA: BlackSpot[] = [
  ...
  { name: "Ajni Railway Station Road (Ajni)", location: { lat: 21.1433, lng: 79.1194 }, accident_count: 12, zone: "Ajni", description: "Railway crossing delays causing risky overtaking" },
  { name: "Seminary Hills Flyover (Dharampeth)", location: { lat: 21.1373, lng: 79.0608 }, accident_count: 11, zone: "Dharampeth", description: "High-speed flyover with sharp curves" },
  { name: "Variety Square to LAD College (Dhantoli)", location: { lat: 21.1518, lng: 79.0826 }, accident_count: 10, zone: "Dhantoli", description: "Heavy student traffic area" },
  { name: "Khamla Square Junction", location: { lat: 21.1201, lng: 79.1025 }, accident_count: 9, zone: "Khamla", description: "Multi-way junction" },
  { name: "Sadar Market Area", location: { lat: 21.1505, lng: 79.0842 }, accident_count: 8, zone: "Sadar", description: "Congested market area" }
];
        ...
        <div className="map-section">
          ...
          <div className="map-legend">
            ...
            <div className="legend-item">
              ...
              <span>Low Risk (&lt;5 accidents)</span>
            </div>
          </div>
        </div>
